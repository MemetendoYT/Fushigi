...
public class NodeEditor
{
	...
	private int selectedConnectionPin;
	private int selectedConnectionNode;
	...
	public void Draw()
	{
		...
		foreach (var node in nodes.Values)
		{
			...
			foreach (var pin in node.GetPins())
			{
				...
				if (ainb.Nodes[node.ID].InputParameters != null)
				{
					drawList.AddText(position, 0xFFFFFFFF, "bazinga");
				}
